...
<body>
	...
	<div class="wrapper" id="wrapper">
		...
		<div class="embed-responsive embed-responsive-16by9" style="background-color: black;">
		  <iframe width="764" height="573" src="https://www.youtube.com/embed/QbWsGFh_pSs?rel=0&autoplay=1&loop=1&mute=1&showinfo=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
		</div>
		</div>
		</div>
