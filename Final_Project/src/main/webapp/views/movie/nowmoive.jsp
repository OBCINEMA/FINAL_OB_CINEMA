...
<body>
	...
	<div class="wrapper" id="wrapper">
		...
		<section class="portfolio-area bg-grey" >
			<div class="container"  style="background-image: url('/resources/img/headImg/onairsign.jpg'); background-repeat: no-repeat; background-size: cover; height: 400px; width: 100%; margin: 0 0 10px 0; padding: 0;">
